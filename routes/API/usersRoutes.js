...
const { getUsers, getUser, newUser, deleteUser, updateUser, getAllWriters } = require('../../controllers/API/usersController');

router.get('/lista_de_usuarios', getUsers);
router.get('/lista_de_usuarios/redactores', getAllWriters);
